...
namespace margelo::nitro::sima {
  ...
  public:
    SimaData() = default;
    explicit SimaData(std::string serviceName, std::string scheme, std::string userPinCode, std::string logo, double clientId, std::string masterKey): serviceName(serviceName), scheme(scheme), userPinCode(userPinCode), logo(logo), clientId(clientId), masterKey(masterKey) {}
  };
  ...
  struct JSIConverter<SimaData> final {
    static inline SimaData fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return SimaData(
        ...
        JSIConverter<std::string>::fromJSI(runtime, obj.getProperty(runtime, "scheme")),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const SimaData& arg) {
      ...
      obj.setProperty(runtime, "scheme", JSIConverter<std::string>::toJSI(runtime, arg.scheme));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::string>::canConvert(runtime, obj.getProperty(runtime, "scheme"))) return false;
